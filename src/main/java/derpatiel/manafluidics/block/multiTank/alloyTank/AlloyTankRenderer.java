...
public class AlloyTankRenderer extends TileEntitySpecialRenderer<AlloyTankTileEntity> {

    @Override
    public void renderTileEntityAt(AlloyTankTileEntity tile, double x, double y, double z, float partialTicks, int destroyStage) {
