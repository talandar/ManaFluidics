...
public class KnowledgeAltarRenderer extends TileEntitySpecialRenderer<KnowledgeAltarTileEntity> {
    /** The texture for the book above the enchantment table. */
    private static final ResourceLocation TEXTURE_BOOK = new ResourceLocation("manafluidics:textures/entity/knowledge_altar_book.png");
    private final ModelBook modelBook = new ModelBook();

    public void renderTileEntityAt(KnowledgeAltarTileEntity te, double x, double y, double z, float partialTicks, int destroyStage)
    {
